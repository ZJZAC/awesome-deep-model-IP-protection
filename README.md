...
+ [Identification Tracing](#Idetification-Tracing)
    + [Fingerprints](#Fingerprints)
      + [Dataset](#Dataset) | [Training](#Training) | [Inference](#Inference) | [Deployment](#Deployment)
...
2. [Radioactive data tracing through training](https://arxiv.org/pdf/2002.00937.pdf): craft a class-specific additive mark in the latent space before the classification layer | sablayrolles2020radioactive | Sablayrolles et al, *ICML* 2020
